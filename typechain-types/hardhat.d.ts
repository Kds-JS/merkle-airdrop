...
declare module "hardhat/types/runtime" {
  interface HardhatEthersHelpers extends HardhatEthersHelpersBase {
    ...
    getContractFactory(
      name: "MultiTokenClaim",
      signerOrOptions?: ethers.Signer | FactoryOptions
    ): Promise<Contracts.MultiTokenClaim__factory>;
    getContractFactory(
      name: "MerkleMultipleAirdrop",
      signerOrOptions?: ethers.Signer | FactoryOptions
    ): Promise<Contracts.MerkleMultipleAirdrop__factory>;
    getContractFactory(
      name: "Token",
      signerOrOptions?: ethers.Signer | FactoryOptions
    ...
    getContractAt(
      ...
      address: string,
      signer?: ethers.Signer
    ): Promise<Contracts.MultiTokenClaim>;
    getContractAt(
      name: "MerkleMultipleAirdrop",
      address: string,
      signer?: ethers.Signer
    ): Promise<Contracts.MerkleMultipleAirdrop>;
    getContractAt(
      name: "Token",
      address: string,
      signer?: ethers.Signer
